...
<div class="col-12">
	<div class="card">
		<div class="card-body">
			...
			if (isset($_POST['simpan'])) {
				...
				if (empty($date) || empty($event) || empty($risk) || empty($mitigation) || empty($progres) || empty($tc) || empty($tr) || empty($status)) {
					...
					// Insert data ke database, tambahkan id_user
					$query = mysqli_query($koneksi, "INSERT INTO cyb_myssc (date, event, risk, mitigation, progres, tc, tr, status, id_user) 
                            VALUES ('$date', '$event', '$risk', '$mitigation', '$progres', '$tc', '$tr', '$status', '$id_user')");
			...
			<form method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="datetime-local" class="form-control" id="tc" name="tc" required>
					</div>
					<label class="control-label col-sm-2 align-self-center mb-0" for="tr">Ticket Resolved:</label>
					<div class="col-sm-4">
						<input type="datetime-local" class="form-control" id="tr" name="tr" required>
					</div>
				</div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="summernote4" rows="5" name="progres" required></textarea>
				</div>
				<div class="form-group row">
