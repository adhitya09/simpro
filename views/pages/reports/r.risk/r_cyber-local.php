...
<div class="col-12">
  <div class="card">
    <div class="card-body">
      <form method="get">
        <input type="hidden" name="page" value="reports/r.risk/r_cyber-local">
        <div class="row">
          ...
          <div class="col-md-12 login-btn-inner">
            ...
            <a href="views/pages/reports/r.risk/r_cyber-local_data.php?type=excel&&month=<?php echo $bul; ?>&year=<?php echo $year; ?>&status=<?php echo $inputStatus; ?>" target="_blank" class="btn btn-success" style="border-radius: 0">
              <i class="fa fa-file-excel-o"></i> Export Excel
            </a>
            <a href="views/pages/reports/r.risk/r_cyber-local_data.php?type=print&&month=<?php echo $bul; ?>&year=<?php echo $year; ?>&status=<?php echo $inputStatus; ?>" target="_blank" class="btn btn-danger" style="border-radius: 0">
      ...
      <table id="datatable" class="table table-striped" data-toggle="data-table">
        ...
        <tbody>
          ...
          $query = mysqli_query($koneksi, "SELECT * FROM cyber $where");
          ...
          ?>
            <tr>
              ...
              <td><?php echo (strlen($data['prg']) > 60) ? substr($data['prg'], 0, 60) . '...' : $data['prg']; ?></td>
              <td>
                <p>
                  <?php
                  switch ($data['status']) {
